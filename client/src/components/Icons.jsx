// Shared inline SVG icons — no external dependency.
// All icons are aria-hidden; callers supply accessible labels via parent elements.
...
export const DirectionsIcon = ({ size = 15 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
    stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
    aria-hidden="true">
...
export const LocateIcon = ({ size = 14 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
    stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
    aria-hidden="true">
...
export const ChevronIcon = ({ size = 14, direction = "down" }) => {
